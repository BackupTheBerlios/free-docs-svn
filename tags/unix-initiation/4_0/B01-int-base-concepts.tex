...
\begin{itemize}
	...
	\item un ensemble de disques physiques~: {\sl Logical Volume} sur IBM,
	      Hewlett Packard et Silicon Graphics, {\sl Domain} sur OSF/1,
	      {\sl Meta Device} sous Sun Solaris,
	\item un syst{\`e}me de fichier distant r{\'e}sidant sur une autre machine
	      (Service NFS).
\end{itemize}
...
\begin{figure}[hbtp]
\centering
%\epsfbox{./_Images/base-concepts/orgdisk.eps}
\includegraphics{./_Images/base-concepts/orgdisk.jpg}[l]
...
\begin{description}
	\item[{\sl Root directiory ("{\tt /}")}]\mbox{}\\
