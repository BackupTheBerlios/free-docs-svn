...
\includegraphics{./_Images/cmds-net/exrcp-cl1.jpg}
}	&
...
\includegraphics{./_Images/cmds-net/exrcp-cl2.jpg}
}	&
	L'utilisateur {\tt willow} sur la machine {\tt dragon} copie le
...
\includegraphics{./_Images/cmds-net/exrcp-cl3.jpg}
}	&
...
\includegraphics{./_Images/cmds-net/exrcp-cl4.jpg}
}	&
	L'utilisateur {\tt willow} sur la machine {\tt dragon} copie le
	fichier {\tt excalibur.c} de l'utilisateur {\tt arthur} sur la
